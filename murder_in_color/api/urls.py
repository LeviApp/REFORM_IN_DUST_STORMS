...
from murder_in_color.api.views import cities_api, city_api, players_api, criminals_api, criminal_api, cases_api, places_api, place_api, witnesses_api, witness_api, responses_api, response_api, clues_api, clue_api
