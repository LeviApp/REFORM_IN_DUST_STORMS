...
17	murder_in_color	0001_initial	2020-03-06 10:58:52.938972-07
...
COPY public.murder_in_color_case (id, case_name, days_left, evidence, signatures, warrant, name, gender, race, height, age, weight, hair_color, face_feature, unique_feature, crime_place, weapon, notebook, solved, user_id) FROM stdin;
\.
...
3	Idaho Springs	Indian Tribe	A friendly Indian community is in view. Indian mothers pick vegetables from the garden while young Indian warriors practice hunting techniques. You smell the herbs that are being used for an ancient ritual in a tent nearby.	1
\.
...
1	Dakota Turner	Male	Indian	Tall	Old	Thin	Black	Large Eyebrows	Limp	Bridge	Hammer
\.
...
COPY public.murder_in_color_player (id, rank, name, description, question_suspect, question_place, question_weapon, goodbye, place_id, city_id, user_id) FROM stdin;
1	Deputy	Jim Carson	My name is Carson, Jim Carson. I am a tall, young man with hair as black as night. I can handle myself in a fight, and can outdraw any outlaw. I wear the badge proudly as I seek to bring reform in the middle of a barren dust storm called the West, the Wild West.	What does the suspect look like?	Do you remember where the crime took place?	Did you see what kind of weapon the suspect had?	Have a wonderful day!	1	1	----
\.
...
28	He showed me his war cry.	He talked about hearing gunshots	I found nothing his hands.	Have a good trip!	28
...
SELECT pg_catalog.setval('public.murder_in_color_case_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.murder_in_color_criminal_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.murder_in_color_player_id_seq', 1, true);
